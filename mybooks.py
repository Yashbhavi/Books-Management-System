...
class Bookdb:
    def __init__(self): #connection to the database
    ...
    def view(self):  #To view the records entered
        self.cursor.execute("SELECT * FROM books")
        rows = self.cursor.fetchall()
        return rows

    def insert(self,title,author,isbn):   #To insert new records 
    ...
    def update(self,id, title, author, isbn):  #To update the existing records
    ...
    def delete(self,id):  #To delete any records
...
db = Bookdb()  # used db variable to create reference of the class for using the methods in it
...
view_btn = Button(root, text="View All Records", bg="orange", fg="white", font="helvetica 10 bold",command=view_records)
...
exit_btn = Button(root, text="Exit Application", bg="indigo", fg="white", font="helvetica 10 bold",command=root.destroy)
